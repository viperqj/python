...
class AdminPage:
    ...
    def login(self):
        ...
        # 数据库操作 查询管理员表
        db = pymysql.connect(host='127.0.0.1',user='root',password='123456',database='rxkc',charset='utf8') # 打开数据库连接
...
class AdminManage:
    def __init__(self, parent_window):
        ...
        self.age = []
        # 打开数据库连接
        db = pymysql.connect(host='127.0.0.1',user='root',password='123456',database='rxkc',charset='utf8')
        cursor = db.cursor()  # 使用cursor()方法获取操作游标
